...
export const caseStudies: CaseStudy = {
  ...
  `,
  solution: `
    Glazed built the storefront using isomorphic approach (mainly because SEO was vital for the type of search that the company wanted to achieve and performance optimisation via caching and mobile-specific code chunks).
  ...
  `,
  result: `
    Digital commerces strongly depend on design decisions to communicate their brand effectively, while at the same time letting each product shine independently.
