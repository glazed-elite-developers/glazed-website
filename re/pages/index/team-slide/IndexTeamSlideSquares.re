  ...
  Belt.Map.fromArray(
    ...
    [|
      ...
      (
        ...
        {
          key: "mariia",
          name: "Mariia Kuznetsova",
          skills: [|"Business development", "Customer Relationship", "Business Growth"|],
          description: "Mariia is the heart of our client relations, ensuring that every partnership is not just successful, but truly meaningful.",
          shortDescription: "She spearheads project discovery and keeps us up-to-date with the latest trends, refining every stage of our business development process.",
          linkedIn: "https://www.linkedin.com/in/pedrosantos3/",
        },
      ),
      (
        "tania",
        {
          ...
          description: "She plays a critical role in driving Glazed's expansion, meticulously crafting and implementing strategies for growth. Her understanding of complex new technologies makes her a valuable asset in navigating the intricacies of innovation.",
          shortDescription: "Tania has extensive experience in IT Security Management, Business Development, and Strategy.",
          linkedIn: "https://www.linkedin.com/in/taniafbarros/",
        },
      ),
      (
        "maria",
        {
          ...
          linkedIn: "https://www.linkedin.com/in/iammasha/",
        },
      ),
      (
        "daniela",
