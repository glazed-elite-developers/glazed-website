  ...
  let content: content = {
    ...
    content: [|
      ...
      Custom(
        <Heading level=Heading.H3 className=Styles.inPageHeading>
          {React.string(
             {j|After leaving Glazed offices, Switch has grown from their initial three-person team to become a completely independent business with a fantastic team of their own, who has since transformed a simple idea into a world-class payment orchestration platform.|j},
           )}
        </Heading>,
      ),
      TextAndImage(
        ...
        After leaving Glazed offices, Switch has grown from their initial three-person team to become a completely independent business with a fantastic team of their own, who has since transformed a simple idea into a world-class payment orchestration platform.
        |j},
        productImage2,
      ),
    |],
