...
Glazed integrated more than 20 payment methods and entities across the world, with diverse specifications.",
    ...
    content: [|
      TextAndImage(
        {j|
        We developed the core architecture, that unites all the distinct payment method flows under a single integration, and allows having several providers per payment method, for cost optimisation and redundancy.
