...
module Styles = {
  ...
  let make = (~mode = Normal) => {
    ...
    let setName = value => { baseSetName(_ => value); };
    let setEmail = value => { baseSetEmail(_ => value); };
    let setMessage = value => { baseSetMessage(_ => value); };

    let handleSubmit = value => { Js.log("submitting"); };
